...
local Window = Fluent:CreateWindow({
    Title = "MIKIMARU HUB",
    SubTitle = "TRUE https://tinyurl.com/28j9uztj",
    TabWidth = 160,
...
ImageButton.Image = "rbxassetid://18416696665"
...
--------------------------------------------------------------------------------------------------------------------------------------------
--Create Tabs
local Farming = Tabs.Race:AddSection("Race")
local listfastattack = {'Normal','Slow','Super','Low'}

    local DropdownDelayAttack = Tabs.Race:AddDropdown("DropdownDelayAttack", {
    ...
    local DropdownSelectWeapon = Tabs.Race:AddDropdown("DropdownSelectWeapon", {
        Title = "Weapon",
        Description = "",
    ...
    Tabs.Race:AddButton({
        Title = "Travel Mirage Island",
        Description = "บินไปที่เกาะลับ",
        Callback = function()
            TweenMirage()
        end
    })
    ...
    Tabs.Race:AddButton({
        Title = "Travel Highest Point",
        Description = "การเดินทางจุดสูงสุด",
        Callback = function()
            TwenetoHighestPoint()
        end
    })
...
local ToggleTweenGear = Tabs.Race:AddToggle("ToggleTweenGear", {Title = "Travel Gear",Description = "เก็บเกียร์", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Race:AddToggle("Togglelockmoon", {Title = "Lock Moon and Use Race Skill",Description = "ออโต้มองพระจันทร์ + ออโต้สกิวเผ่า", Default = false })
...
local SettingFarm = Tabs.Race:AddSection("Farming")

local ToggleFast = Tabs.Race:AddToggle("ToggleFast", {Title = "Fast Attack",Description = "ความเร็วโจมตี", Default = true })
...
while wait() do
    ...
    local ToggleBringMob = Tabs.Race:AddToggle("ToggleBringMob", {Title = "Bring Mob",Description = "รวมมอน", Default = true })
   ToggleBringMob:OnChanged(function(Value)
    ...
    local ToggleBypassTP = Tabs.Race:AddToggle("ToggleBypassTP", {Title = "Bypass Tp",Description = "วาป + รีตัว", Default = false })
...
local Time = Tabs.Race:AddParagraph({
        Title = "Time Zone",
        Content = "เวลา"
    })
    ...
    local Timekl = Tabs.Race:AddParagraph({
        Title = "Client Server",
        Content = "เซิร์ฟเวอร์ไคลเอนต์"
    })
...
local FM = Tabs.Race:AddParagraph({
        Title = "Full Moon",
        Content = "พระจันทร์"
    })
...
local Mirragecheck = Tabs.Race:AddParagraph({
...
local Mastery = Tabs.Race:AddSection("Travel Island - ไปที่เกาะต่างๆ")
...
Tabs.Race:AddButton({
    ...
    Tabs.Race:AddButton({
        Title = "Un Travel island",
        Description = "หยุดไปที่เกาะ",
        Callback = function()
          CancelTween()
        end
    })
...
Tabs.profile:AddParagraph({
        Title = "link Youtube MIKIMARU HUB",
        Content = "https://tinyurl.com/28j9uztj"
    })      
--------------------------------------------------------------------------------------------------------------------------------------------
--Hop

if First_Sea or Second_Sea then
    local Mastery = Tabs.Race:AddSection("third sea pls !!!!")
end

if Third_Sea then
local ToggleFindMoon = Tabs.Race:AddToggle("ToggleFindMoon", {Title = "Server Hop Full Moon",Description = "", Default = false })
...
local ToggleMirageIsland = Tabs.Race:AddToggle("ToggleMirageIsland", {Title = "Server Hop Mirage Island",Description = "", Default = false })
